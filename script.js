...
var loadingPanel = document.querySelector("#unity-loading");
var loadingBar = document.querySelector(".progress-bar2");
...
var config = {
    ...
    productName: "2dversePreviwerApp",
...
createUnityInstance(canvas, config, (progress) => {
	...
	if(p < 90){
		loadingText.innerHTML = "Loading " + p + "%";
	}
	else {
		loadingText.innerHTML = "Preparing " + p + "%";
	}
